...
function repCard(selectionOutput) {
  $('.primaryUl').append('<li class="header secondaryLi" id="'+ selectionOutput +'">'+ selectionOutput + ' - '+ repInfo[selectionOutput].rank +'</li>');
  $('.primaryUl').append('<li class="subHeader secondaryLi" id="'+ repInfo[selectionOutput].market +'">'+ repInfo[selectionOutput].market +'</li>');
  $('.primaryUl').append('<li class="conglomerate secondaryLi" id="'+ repInfo[selectionOutput].conglomerate +'">Conglomerate: '+ repInfo[selectionOutput].conglomerate +'</li>');
